...
/**
 * Get the edges from the "logs" collection.
 *
 * @auth assistant
 * @order createdAt
 */
export default defineConditionallyCachedEventHandler(async (event) => {
	const { firebaseFirestore } = getServerFirebase("api:admin:instance:logs");
	...
	try {
		...
		let query: CollectionReference | Query = firebaseFirestore.collection("logs");
